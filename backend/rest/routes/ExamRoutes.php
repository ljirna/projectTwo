...
Flight::route('DELETE /employee/delete/@employee_id', function ($employee_id) {
    ...
    Flight::examService()->delete_employee($employee_id, $data);
...
Flight::route('GET /orders/report', function () {
    ...
    $offset = 0;
    $limit = 20;
    Flight::json(Flight::examService()->get_orders_report($offset, $limit));
});
...
Flight::route('GET /order/details/@order_id', function ($order_id) {
    ...
    $offset = 0;
    $limit = 5;
    Flight::json(Flight::examService()->get_order_details($order_id, $offset, $limit));
});
